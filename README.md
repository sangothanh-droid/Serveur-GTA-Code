...
| `server-data/resources/[local]/rp-shoprobbery`, `rp-carjack`, `rp-drugdealing`, `rp-illegalrace`, `rp-laundering`, `rp-heist`, `rp-armstrafficking`, `rp-turfwar`, `rp-weedfarm` | 9 activités criminelles jouables, voir `docs/CRIME-JOBS.md` |
